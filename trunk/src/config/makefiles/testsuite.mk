...
# Build path 
#
BUILD_PATH			= ../../../../../build/snowleopard
TST_BUILD_PATH			= $(BUILD_PATH)/test

TST_TC_BUILD_PATH		= $(BUILD_PATH)/libsltc
TST_TST_BUILD_PATH		= $(BUILD_PATH)/libsltst

#-------------------------------------------------------------------------------
# Compiler options
#
TST_COMPILE_FLAGS		= -std=c99 -Wall -Wextra -Werror
TST_DEBUG_FLAGS			= -g
