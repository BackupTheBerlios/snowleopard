...
# run_10_test_put.sh
#-------------------------------------------------------------------------------
# Test script for get.sh/put.sh. Check if get.sh/put.sh works the same way on 
# the shell as on sh.
#-------------------------------------------------------------------------------

result_file=$1

echo '==> Running get.sh/put.sh test script'
...
echo '<== Finished get.sh/put.sh test script'
