...
#-------------------------------------------------------------------------------
# run_6_test_overwrite.sh
#-------------------------------------------------------------------------------
# Test script for overwrite.sh. Check if overwrite.sh works the same way on the 
# shell as on sh.
#-------------------------------------------------------------------------------

result_file=$1

echo '==> Running overwrite.sh test script'
...
echo '<== Finished overwrite.sh test script'
