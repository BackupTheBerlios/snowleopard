...
#-------------------------------------------------------------------------------
# run_5_test_checkmail.sh
#-------------------------------------------------------------------------------
# Test script for checkmail.sh. Check if checkmail.sh works the same way on the 
# shell as on sh.
#-------------------------------------------------------------------------------

result_file=$1

echo '==> Running checkmail.sh test script'
...
echo '<== Finished checkmail.sh test script'
