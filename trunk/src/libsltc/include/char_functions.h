...
#ifndef __SL_TC_CHAR_FUNCTIONS_H__
#define __SL_TC_CHAR_FUNCTIONS_H__
...
bool tc_is_octal_digit (char);
bool tc_is_whitespace (char);
//------------------------------------------------------------------------------

#endif /* !__SL_TC_CHAR_FUNCTIONS_H__ */
